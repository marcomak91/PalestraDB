...
while($cicle=mysql_fetch_array($query)){ 
    echo "<tr><td>".$cicle['CodiceFiscale']."</td><td>".$cicle['Nome']."</td><td>".$cicle['Cognome']."</td><td>".$cicle['DataNascita']."</td><td>".$cicle['LuogoNascita']."</td><td>".$cicle['Indirizzo']."</td><td>".$cicle['Sesso']."</td><td>".$cicle['Telefono']."</td><td>".$cicle['Stipendio']."</td></tr>" ;  
} 
?> 
</table>
