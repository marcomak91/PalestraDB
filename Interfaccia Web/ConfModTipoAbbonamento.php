...
$query=mysql_query("UPDATE TipoAbbonamento SET Prezzo='$Prezzo' WHERE Durata='$Durata'"); 

if (!$query) {
	die("Errore nella query: " . mysql_error());}
else{ 
?>
<h2>Aggiornamento Tipo Abbonamento Avvenuto<br>Scegli Un' Operazione:</h2>
<table align="center">
<form action="VisTipoAbbonamento.php" align="left">
