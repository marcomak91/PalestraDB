...
$query = mysql_query("SELECT *, ScadenzaBadge(CodiceFiscale) AS DataFine FROM Abbonato NATURAL JOIN Cliente JOIN Badge ON CodiceFiscale=CodAbbonato ORDER BY CodiceFiscale"); 
