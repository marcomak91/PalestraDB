...
$query=mysql_query("UPDATE PrezzoEntrata SET Prezzo='$Prezzo' WHERE Giorno='$Giorno'"); 

if (!$query) {
	die("Errore nella query: " . mysql_error());}
else{
?>
<h2>Aggiornamento Prezzo Entrata Avvenuto<br>Scegli Un' Operazione:<h2>
<table align="center">
<form action="VisPrezzoEntrata.php" align="left">
