...
<body class="visual">
<h2 align="center"> Segretario</h2>
<table align="right" width="100%" CELLSPACING="40" clasS="vis"> 
<tr>
...
$query = mysql_query("SELECT * FROM Segretario NATURAL JOIN Personale"); 
while($cicle=mysql_fetch_array($query)){ 
    echo "<tr><td>".$cicle['CodiceFiscale']."</td><td>".$cicle['Nome']."</td><td>".$cicle['Cognome']."</td><td>".$cicle['Password']."</td></tr>";
} 
?> 
</table>
