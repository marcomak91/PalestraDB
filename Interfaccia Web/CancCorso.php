...
<body class="bcenter">
<h2>Cancellazione Corso </h2>
<table align="center"><tr>
<form action="EliminaCorso.php"  method="POST">
<td>
CodCorso:
<select name="CodCorso">
<?php 
include("connessione_db.php"); 

$query = mysql_query("SELECT CodCorso FROM Corso"); 
while($cicle=mysql_fetch_array($query)){ 
    echo "<option>".$cicle['CodCorso']."</option>" ;  
} 
?>
</select>
</td><td>
