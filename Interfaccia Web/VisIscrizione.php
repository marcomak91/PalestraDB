...
<body class="visual">
<h2 align="center"> Iscrizione </h2>
<table align="center" width="90%" CELLSPACING="30" class="vis"> 
<tr>
<td><b>CodiceCliente</b></td>
<td><b>Nome</b></td>
<td><b>Cognome</b></td>
<td><b>CodCorso</b></td>
<td><b>Giorno</b></td>
...
$query = mysql_query("SELECT * FROM Iscrizione JOIN Cliente ON CodCliente=CodiceFiscale NATURAL JOIN Corso"); 
while($cicle=mysql_fetch_array($query)){ 
    echo "<tr><td>".$cicle['CodCliente']."</td><td>".$cicle['Nome']."</td><td>".$cicle['Cognome']."</td><td>".$cicle['CodCorso']."</td><td>".$cicle['Giorno']."</td><td>".$cicle['Tipo']."</td></tr>";
} 
?> 
</table>
